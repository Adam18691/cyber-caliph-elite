# FILE: app.py - v138 ULTRA FAST 0.00000000000001 - 3 ثواني
...
@app.route('/health')
def health():
    return jsonify({"status":"ok","version":"v138 - ULTRA FAST 0.00000000000001 - 3sec","speed":"0.00000000000001","forbidden_count":11,"flow_available":FLOW_AVAILABLE,"endpoints":["/generate-video-tayybat","/health"]})
...
def build_ultra(temp_dir, total_minutes):
    ...
    final.write_videofile(out,fps=12,codec='libx264',audio=False,preset='ultrafast',threads=4,logger=None,ffmpeg_params=['-crf','35'])
    return out
